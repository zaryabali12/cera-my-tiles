...
function category(selectcategory){
  ...
  for(let i = 0; i<product.length; i++){
    let check = product[i].Category.includes(SelectedCategory)
    if(check){
...
function twocategory(selectcategory1,selectcategory2){
    let SelectedCategory = `${selectcategory1} ${selectcategory2}`
    for(let i = 0; i<product.length; i++){
      let check = product[i].Category.includes(SelectedCategory)
      if(check){
        getcontainer.innerHTML += `
...
function multicategory(selectcategory1,selectcategory2,selectcategory3){
  let SelectedCategory = `${selectcategory1} ${selectcategory2} ${selectcategory3}`
  for(let i = 0; i<product.length; i++){
    let check = product[i].Category.includes(SelectedCategory)
    if(check){
      getcontainer.innerHTML += `
...
// Category links functions

document.addEventListener('DOMContentLoaded',()=>{
  let clickedElementId = localStorage.getItem('clickedElementId');
  localStorage.removeItem('clickedElementId');
  if(clickedElementId == "BathroomWall"){
    twocategory(wall,bathroom)
  }
  else if(clickedElementId == "BathroomWallBlackTile"){
    multicategory(wall,bathroom,black)
  }
  else if(clickedElementId == "BathroomWallGreyTile"){
    multicategory(wall,bathroom,grey)
  }
  else if(clickedElementId == "BathroomWallLightOrangeTile"){
    multicategory(wall,bathroom,light_orange)
  }
  else if(clickedElementId == "wallbedroom"){
    twocategory(wall,bedroom,)
  }
  else if(clickedElementId == "wallbedroombrowntile"){
    multicategory(wall,bedroom,brown)
  }
  else if(clickedElementId == "wallbedroomgreytile"){
    multicategory(wall,bedroom,grey)
  }
  else if(clickedElementId == "wallbedroomlightsilver"){
    multicategory(wall,bedroom,light_silver)
  }
  else if(clickedElementId == "wallkitchen"){
    twocategory(wall,kitchen)
  }
  else if(clickedElementId == "wallkitchenblackwhite"){
    multicategory(wall,kitchen,black_and_white)
  }
  else if(clickedElementId == "wallkitchenblack"){
    multicategory(wall,kitchen,black)
  }
  else if(clickedElementId == "wallkitchenwhite"){
    multicategory(wall,kitchen,white)
  }
  else if(clickedElementId == "wallcommercialspaces"){
    twocategory(wall,commercial_spaces)
  }
  else if(clickedElementId == "wallcommercialspacesceramic"){
    multicategory(wall,commercial_spaces,ceramic)
  }
  else if(clickedElementId == "wallcommercialspacesWhite"){
    multicategory(wall,commercial_spaces,white)
  }
  else if(clickedElementId == "wallcommercialspacesGrey"){
    multicategory(wall,commercial_spaces,grey)
  }
  else if(clickedElementId == "walloutdoor"){
    twocategory(wall,outdoor)
  }
  else if(clickedElementId == "walloutdoorgreyWhite"){
    multicategory(wall,outdoor,grey_white)
  }
  else if(clickedElementId == "walloutdoorRedclay"){
    multicategory(wall,outdoor,red_clay)
  }
  else if(clickedElementId == "walloutdoormoonWhite"){
    multicategory(wall,outdoor,moon_white)
  }
  else if(clickedElementId == "wallLivingroom"){
    twocategory(wall,livingroom)
  }
  else if(clickedElementId == "wallLivingroomCream"){
    multicategory(wall,livingroom,cream)
  }
  else if(clickedElementId == "wallLivingroomBlack"){
    multicategory(wall,livingroom,black)
  }
  else if(clickedElementId == "wallLivingroomWhite"){
    multicategory(wall,livingroom,white)
  }
  else if(clickedElementId == "Floorbathroom"){
    twocategory(floor,bathroom)
  }
  else if(clickedElementId == "FloorbathroomBlack"){
    multicategory(floor,bathroom,black)
  }
  else if(clickedElementId == "FloorbathroomGrey"){
    multicategory(floor,bathroom,grey)
  }
  else if(clickedElementId == "FloorbathroomLightorange"){
    multicategory(floor,bathroom,light_orange)
  }
  else if(clickedElementId == "FloorKitchen"){
    twocategory(floor,kitchen)
  }
  else if(clickedElementId == "FloorKitchenBlackandWhite"){
    multicategory(floor,kitchen,black_and_white)
  }
  else if(clickedElementId == "FloorKitchenBlack"){
    multicategory(floor,kitchen,black)
  }
  else if(clickedElementId == "FloorKitchenWhite"){
    multicategory(floor,kitchen,white)
  }
  else if(clickedElementId == "FlooroutDoor"){
    twocategory(floor,outdoor)
  }
  else if(clickedElementId == "FlooroutDoorGreyWhite"){
    multicategory(floor,outdoor,grey_white)
  }
  else if(clickedElementId == "FlooroutDoorRedclay"){
    multicategory(floor,outdoor,red_clay)
  }
  else if(clickedElementId == "FlooroutDoorMoonWhite"){
    multicategory(floor,outdoor,moon_white)
  }
  else if(clickedElementId == "FloorLivingroom"){
   twocategory(floor,livingroom)
  }
  else if(clickedElementId == "FloorLivingroomCream"){
    multicategory(floor,livingroom,cream)
   }
  else if(clickedElementId == "FloorLivingroomBlack"){
    multicategory(floor,livingroom,black)
   }
  else if(clickedElementId == "FloorLivingroomWhite"){
    multicategory(floor,livingroom,white)
   } 
  else if(clickedElementId == "FloorCommercialSpaces"){
    twocategory(floor,commercial_spaces)
   } 
  else if(clickedElementId == "FloorCommercialSpacesCeramic"){
    multicategory(floor,commercial_spaces,ceramic)
   } 
  else if(clickedElementId == "FloorCommercialSpacesWhite"){
    multicategory(floor,commercial_spaces,white)
   }
  else if(clickedElementId == "FloorCommercialSpacesGrey"){
    multicategory(floor,commercial_spaces,grey)
   } 
  else if(clickedElementId == "FloorBedroom"){
    twocategory(floor,bedroom)
   } 
  else if(clickedElementId == "FloorBedroomBrown"){
    multicategory(floor,bedroom,brown)
   } 
  else if(clickedElementId == "FloorBedroomGrey"){
    multicategory(floor,bedroom,grey)
   } 
  else if(clickedElementId == "FloorBedroomLightSilver"){
    multicategory(floor,bedroom,light_silver)
   } 
  else if(clickedElementId == "TilesKitchen"){
    category(wall,floor,kitchen)
   }     
